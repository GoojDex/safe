! function (e, t, r, i) {
    ...
    function d() {
        function e(e, t, r) {
            var i, n;
            for (u = e, m = t, g = r, f = new Array(h), i = 0; h > i; i++) f[i] = new Array(4), n = f[i], n[0] = n[1] = n[2] = (i << S + 8) / h | 0, D[i] = F / h | 0, G[i] = 0
        }
        ...
        function i() {
            var e, t, r, i, n, o, a, f, h, C, x, F, O, W;
            for (y > m && (g = 1), l = 30 + (g - 1) / 3, F = u, O = 0, W = m, x = m / (3 * g), C = x / k | 0, f = V, o = T, a = o >> R, 1 >= a && (a = 0), e = 0; a > e; e++) N[e] = f * ((a * a - e * e) * H / (a * a));
            for (h = y > m ? 3 : m % p !== 0 ? 3 * p : m % v !== 0 ? 3 * v : m % b !== 0 ? 3 * b : 3 * w, e = 0; x > e;)
                if (r = (255 & F[O + 0]) << S, i = (255 & F[O + 1]) << S, n = (255 & F[O + 2]) << S, t = c(r, i, n), d(f, t, r, i, n), 0 !== a && s(a, t, r, i, n), O += h, O >= W && (O -= m), e++, 0 === C && (C = 1), e % C === 0)
                    for (f -= f / l, o -= o / I, a = o >> R, 1 >= a && (a = 0), t = 0; a > t; t++) N[t] = f * ((a * a - t * t) * H / (a * a))
        }
        ...
        function a() {
            var e;
            for (e = 0; h > e; e++) f[e][0] >>= S, f[e][1] >>= S, f[e][2] >>= S, f[e][3] = e
        }
        ...
        function c(e, t, r) {
            ...
            for (l = ~(1 << 31), u = l, d = -1, c = d, i = 0; h > i; i++) m = f[i], n = m[0] - e, 0 > n && (n = -n), o = m[1] - t, 0 > o && (o = -o), n += o, o = m[2] - r, 0 > o && (o = -o), n += o, l > n && (l = n, d = i), a = n - (G[i] >> x - S), u > a && (u = a, c = i), s = D[i] >> W, D[i] -= s, G[i] += s << O;
            return D[d] += E, G[d] -= A, c
        }
        var l, u, m, g, f, h = 256,
            p = 499,
            v = 491,
    ...
    function m() {
        ...
        var r = arguments.length > 0 && arguments[0] !== i ? arguments[0] : {},
            ...
            g = void 0,
            f = void 0;
        return c.error ? n(c) : (f = new W(a), w.each(o, function (r, i) {
            var o = i;
    ...
    function g(e) {
        e = w.isObject(e) ? e : {}, U.stopVideoStreaming(e)
    }
    ...
    function f(e, r) {
        ...
        i.crop = m, i.videoElement = c, i.videoWidth = l, i.videoHeight = u, i.cameraStream = d, w.isElement(c) && (c.width = a + m.width, c.height = s + m.height, i.webcamVideoElement || (w.setCSSAttr(c, {
            position: "fixed",
            opacity: "0"
        }), t.body.appendChild(c)), c.play(), A.getGIF(i, function (e) {
    ...
    function p() {
        ...
        return o() ? n.savedRenderingContexts.length ? (A.getGIF(n, function (e) {
            t(e)
        }), void 0) : (U.startVideoStreaming(function () {
            var e = arguments.length > 0 && arguments[0] !== i ? arguments[0] : {};
            e.options = n || {}, f(e, t)
        }, {
            lastCameraStream: r,
    ...
    var w = {
        ...
        O = function () {},
        W = function (e) {
            this.canvas = null, this.ctx = null, this.repeat = 0, this.frames = [], this.numRenderedFrames = 0, this.onRenderCompleteCallback = O, this.onRenderProgressCallback = O, this.workers = [], this.availableWorkers = [], this.generatingGIF = !1, this.options = e, this.initializeWebWorkers(e)
        };
    W.prototype = {
        workerMethods: c(),
        ...
        addFrame: function (e, t) {
            ...
            var r = this,
                ...
                u = d.fontFamily,
                m = d.fontWeight,
                g = (d.gifHeight, d.gifWidth, d.text),
                f = d.textAlign,
                h = d.textBaseline,
                p = t.textXCoordinate ? t.textXCoordinate : "left" === f ? 1 : "right" === f ? o : o / 2,
                v = t.textYCoordinate ? t.textYCoordinate : "top" === h ? 1 : "center" === h ? a / 2 : a,
                b = m + " " + s + " " + u,
                y = void 0;
            try {
                i.filter = c, i.drawImage(e, 0, 0, o, a), g && (i.font = b, i.fillStyle = l, i.textAlign = f, i.textBaseline = h, i.fillText(g, p, v)), y = i.getImageData(0, 0, o, a), r.addFrameImageData(y)
            } catch (C) {
                return "" + C
            }
        },
        ...
        A = {
            getGIF: function () {
                ...
                var n = t.createElement("canvas"),
                    ...
                    O = Number(e.gifWidth),
                    A = Number(e.gifHeight),
                    U = Number(e.interval),
                    R = (Number(e.sampleInterval), s ? 0 : 1e3 * U),
                    M = [],
                    T = v.length ? v.length : e.numFrames,
                    I = T,
                    j = new W(e),
                    V = w.getFontSize(e),
                    z = e.textXCoordinate ? e.textXCoordinate : "left" === y ? 1 : "right" === y ? O : O / 2,
                    H = e.textYCoordinate ? e.textYCoordinate : "top" === C ? 1 : "center" === C ? A / 2 : A,
                    L = g + " " + V + " " + m,
                    B = c ? Math.floor(c.scaledWidth / 2) : 0,
                    P = c ? x - c.scaledWidth : 0,
                    G = c ? Math.floor(c.scaledHeight / 2) : 0,
                    D = c ? k - c.scaledHeight : 0,
                    N = function q() {
                        function e() {
                            try {
                                P > x && (P = x), D > k && (D = k), 0 > B && (B = 0), 0 > G && (G = 0), o.filter = l, o.drawImage(S, B, G, P, D, 0, 0, O, A), t()
                            } catch (r) {
                        ...
                        function t() {
                            var e = void 0;
                            p && M.push(o.getImageData(0, 0, O, A)), b && (o.font = L, o.fillStyle = u, o.textAlign = y, o.textBaseline = C, o.fillText(b, z, H)), e = o.getImageData(0, 0, O, A), j.addFrameImageData(e), I = i, h((T - I) / T), i > 0 && w.requestTimeout(q, R), I || j.getBase64GIF(function (e) {
                                r({
                                    error: !1,
                                    errorCode: "",
                                    errorMsg: "",
                                    ...
                                    savedRenderingContexts: M,
                                    keepCameraOn: f
                                })
                            })
                        }
                        var i = I - 1;
                        v.length ? (o.putImageData(v[T - I], 0, 0), t()) : e()
                    };
                T = T !== i ? T : 10, U = U !== i ? U : .1, n.width = O, n.height = A, o = n.getContext("2d"),
                    function X() {
                        return v.length || 0 !== S.currentTime ? (N(), void 0) : (w.requestTimeout(X, 100), void 0)
                    }()
            },
        ...
        U = {
            ...
            findVideoSize: function T(e) {
                ...
                var t = e.cameraStream,
                    ...
                    i = e.videoElement;
                i && (i.videoWidth > 0 && i.videoHeight > 0 ? (i.removeEventListener("loadeddata", U.findVideoSize), r({
                    videoElement: i,
                    cameraStream: t,
                    ...
                    videoElement: i,
                    cameraStream: t,
                    videoWidth: U.defaultVideoDimensions.width,
                    videoHeight: U.defaultVideoDimensions.height
                }))
            },
            ...
            stream: function (e) {
                ...
                if (w.isFunction(n) && n(), t) {
                    if (w.isString(t)) o.src = t, o.innerHTML = '<source src="' + t + '" type="video/' + w.getExtension(t) + '" />';
                ...
                o.play(), w.requestTimeout(function s() {
                    s.count = s.count || 0, U.loadedData === !0 ? (U.findVideoSize({
                        videoElement: o,
                        cameraStream: r,
                        completedCallback: i
                    }), U.loadedData = !1) : (s.count += 1, s.count > 10 ? U.findVideoSize({
                        videoElement: o,
                        cameraStream: r,
                        completedCallback: i
                    }) : s())
            ...
            startStreaming: function (e) {
                ...
                o && (l.crossOrigin = d.crossOrigin), l.autoplay = !0, l.loop = !0, l.muted = !0, l.addEventListener("loadeddata", function () {
                    U.loadedData = !0, d.offset && (l.currentTime = d.offset)
                }), a ? U.stream({
                    videoElement: l,
                    existingVideo: a,
                    completedCallback: n
            ...
            startVideoStreaming: function (e) {
                ...
                r > 0 && (a = w.requestTimeout(function () {
                    U.onStreamingTimeout(n)
                }, 1e4)), U.startStreaming({
                    error: function () {
                        n({
                            error: !0,
                            errorCode: "getUserMedia",
    ...
    "function" == typeof define && define.amd ? define([], function () {
        return R
    }) : "undefined" != typeof exports ? module.exports = R : e.gifshot = R
